...
var image = new image();
image.src = 'C:\Users\Dellm\Downloads\memory-Lock90-master\assets\animals.png'
...
if (card.flip){
	ctx.drawImage(image,640 / card.card % 3 * 212  0,0,212,212,x * 165+3, y * 165+3, 160 , 160);
	//render animal
}
else{
	// draw the back of the card (212x212px)
	ctx.fill sytle = "#3333ff";
